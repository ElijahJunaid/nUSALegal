  ...
  criminal: [
    {
      ...
      facts:
        "Bill, an employee at Rip Off., Inc. in Los Angeles, allegedly attempted to burn a chair in his boss's office. The fire spread due to wind from an open window in the 20th-floor penthouse suite. The defendant alerted security and initiated fire protocols, but the office was severely damaged.",
      difficulty: '6/10',
      statute:
        '18 U.S. Code § 844(i) - Attempted arson (unlawful attempt to damage/destroy a building used in interstate commerce)',
      evidence: {
        prosecution: [
      ...
      roles: {
        ...
        jury: {
          ...
          verdict_options: ['Guilty of attempted arson', 'Not guilty']
        }
      }
    }
  ],
  civil: [
    {
      ...
      facts:
        'John Smith hired Jones Construction to renovate his home for $50,000. Work was completed only 60% before Jones Construction abandoned the project. Smith seeks damages for breach of contract and cost to complete with another contractor ($30,000).',
      difficulty: '5/10',
      evidence: {
        plaintiff: [
      ...
      roles: {
        ...
        jury: {
          ...
          verdict_options: ['Liable for breach (award damages)', 'Not liable (no damages)']
        }
      }
    }
  ]
