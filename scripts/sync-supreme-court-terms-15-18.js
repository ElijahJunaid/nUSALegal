...
/**
 * sync-supreme-court-terms-15-18.js
 * Syncs Supreme Court Terms 15-18 from Trello board cz62lo6v into
...
async function main() {
  ...
  const fileContent = `// Auto-generated by sync-supreme-court-terms-15-18.js
// DO NOT EDIT MANUALLY - Run script to update

export const supremeCourtRulingsTerms15To18 = [
${rulingsTs}
]

export default supremeCourtRulingsTerms15To18
`

  fs.writeFileSync(OUTPUT_FILE, fileContent, 'utf8')
  console.log(`\n📁 Generated: ${OUTPUT_FILE}`)
  console.log(`🎉 Supreme Court Terms 15-18 sync completed successfully!`)
}
