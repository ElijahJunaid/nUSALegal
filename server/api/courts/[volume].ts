      ...
      cases: [
        {
          ...
          ruling: 'A motion by the FEC is only bias if it is prejudicial or non-uniform.',
          type: 'CIVIL',
          docket: '38HT1',
        ...
        },
        {
          ...
          ruling: 'The Tow Truck Service is under the jurisdiction of the City.',
          type: 'CIVIL',
          docket: '38G17',
        ...
        },
        {
          ...
          ruling: 'House of Representatives cannot ordain resolutions that are unconstitutional.',
          type: 'CIVIL',
          docket: '1-10',
        ...
        },
        {
          ...
          ruling: 'A trial in absentia may only occur with notice and other due process rights.',
          type: 'CRIMINAL',
          docket: '2-11',
        ...
        },
        {
          ...
          ruling: 'A Judge may not issue contempt for intra legem issues and other COC issues.',
          type: 'CIVIL',
          docket: '2-12',
        ...
        },
        {
          ...
          ruling: 'Reaffirming George v. Capitalized, 2 U.S. 8 (2016).',
          type: 'CIVIL',
          docket: '2-16',
      ...
      cases: [
        {
          ...
          ruling: 'Case remanded to District Court per All Writs Act.',
          type: 'CIVIL',
          docket: '3-1',
        ...
        },
        {
          ...
          description:
            'Government cannot fire employees for conduct or speech off team without substantial interest.',
          ruling:
            'Government cannot fire employees for conduct or speech off team without substantial interest.',
          type: 'CIVIL',
          docket: '3-4',
        ...
        },
        {
          ...
          ruling: 'Reaffirming United States v. Las Vegas, 2 U.S. 24 (2017).',
          type: 'CIVIL',
          docket: '3-5',
        ...
        },
        {
          ...
          description:
            'Second amendment protects right to bear arms, not an unlimited right to bear in any manner.',
          ruling:
            'Second amendment protects right to bear arms, not an unlimited right to bear in any manner.',
          type: 'CIVIL',
          docket: '3-6',
        ...
        },
        {
          ...
          description:
            'Speaker of the House cannot vote except in cases of tiebreaking votes (OLD CONST.).',
          ruling:
            'Speaker of the House cannot vote except in cases of tiebreaking votes (OLD CONST.).',
          type: 'CIVIL',
          docket: '3-7',
      ...
      cases: [
        {
          title: 'United States v. Las Vegas',
          description:
            'Courts should not issue a ruling without an injury to be redressed, thus violating the C&C Clause.',
          ruling:
            'Courts should not issue a ruling without an injury to be redressed, thus violating the C&C Clause.',
          type: 'CIVIL',
          docket: '4-2',
        ...
        },
        {
          ...
          description:
            'No Judge may issue contempt in cases which they do not preside in and other COC issues.',
          ruling:
            'No Judge may issue contempt in cases which they do not preside in and other COC issues.',
          type: 'CIVIL',
          docket: '4-8',
        ...
        },
        {
          ...
          description:
            'At-will employment is constitutional, Fourteenth Amendment issues and other employee rights.',
          ruling:
            'At-will employment is constitutional, Fourteenth Amendment issues and other employee rights.',
          type: 'CIVIL',
          docket: '4-3',
        ...
        },
        {
          ...
          ruling: 'Lower Court Affirmed in equally divided Court.',
          type: 'CIVIL',
          docket: '4-26',
      ...
      cases: [
        {
          ...
          ruling: 'Application for Group Warrant.',
          type: 'Civil',
          docket: '5-14',
        ...
        },
        {
          ...
          ruling: 'A five month imprisonment sentence did not violate the 8th Amendment.',
          type: 'CRIMINAL',
          docket: '5-7',
        ...
        },
        {
          ...
          description:
            'Application for Group Warrant, the size of the group should be a considered factor and necessity.',
          ruling:
            'Application for Group Warrant, the size of the group should be a considered factor and necessity.',
          type: 'CRIMINAL',
          docket: '5-22',
        ...
        },
        {
          ...
          description:
            'A pardon vacates a sentence and in turn vacates any possibility of review of the vacated sentence.',
          ruling:
            'A pardon vacates a sentence and in turn vacates any possibility of review of the vacated sentence.',
          type: 'CRIMINAL',
          docket: '5-25',
        ...
        },
        {
          ...
          ruling: 'Suits cannot occur for injuries not relevant to the pursued jurisdiction.',
          type: 'Civil',
          docket: '5-33',
        ...
        },
        {
          ...
          ruling: 'Rules of mootness apply to Anytime Review cases.',
          type: 'Civil',
          docket: '5-35',
        ...
        },
        {
          ...
          description:
            'Prosecutions by the District of Columbia Gov. stayed in Federal Court pending SCOTUS case.',
          ruling:
            'Prosecutions by the District of Columbia Gov. stayed in Federal Court pending SCOTUS case.',
          type: 'CRIMINAL',
          docket: '5-43',
        ...
        },
        {
          ...
          description:
            'Compulsory Process Clause is a right and the right to call witnesses is imperative to a fair trial.',
          ruling:
            'Compulsory Process Clause is a right and the right to call witnesses is imperative to a fair trial.',
          type: 'CRIMINAL',
          docket: '5-27',
        ...
        },
        {
          ...
          ruling: 'Writ dismissed for mootness.',
          type: 'Civil',
          docket: '5-41',
        ...
        },
        {
          ...
          ruling: 'Courts shall follow mandatory language regarding procedure in statutes.',
          type: 'Civil',
          docket: '5-49',
        ...
        },
        {
          ...
          description:
            'Upholding George v. Troyan, 5 U.S. 91 (2018) and vacating the lower Court judgement.',
          ruling:
            'Upholding George v. Troyan, 5 U.S. 91 (2018) and vacating the lower Court judgement.',
          type: 'CRIMINAL',
          docket: '5-55',
        ...
        },
        {
          ...
          description:
            'Municipalities may prosecute city crimes in Federal Court and cannot create their own Courts.',
          ruling:
            'Municipalities may prosecute city crimes in Federal Court and cannot create their own Courts.',
          type: 'Civil',
          docket: '5-43',
        ...
        },
        {
          ...
          description:
            'No person shall be held in contempt without intent or for issues out of their managable control.',
          ruling:
            'No person shall be held in contempt without intent or for issues out of their managable control.',
          type: 'Civil',
          docket: '5-63',
      ...
      cases: [
        {
          ...
          description:
            'Clan Managers and their entities are immune from suit when acting in their official capacities.',
          ruling:
            'Clan Managers and their entities are immune from suit when acting in their official capacities.',
          type: 'CRIMINAL',
          docket: '6-64',
        ...
        },
        {
          ...
          ruling: 'Mootness doctrine embraced and Writ dismissed.',
          type: 'CIVIL',
          docket: '5-72',
        ...
        },
        {
          ...
          description:
            'Congress cannot overly deligate Article III powers to a non-Article III Court.',
          ruling: 'Congress cannot overly deligate Article III powers to a non-Article III Court.',
          type: 'CIVIL',
          docket: '5-75',
        ...
        },
        {
          ...
          description:
            'Only SCOTUS may overturn its precedents and how the Court responds to election issues.',
          ruling:
            'Only SCOTUS may overturn its precedents and how the Court responds to election issues.',
          type: 'CIVIL',
          docket: '5-77',
        ...
        },
        {
          ...
          description:
            "Upholding the 'Enhancing the Judiciary Act's provisions on dismissals with prejudice.",
          ruling:
            "Upholding the 'Enhancing the Judiciary Act's provisions on dismissals with prejudice.",
          type: 'CIVIL',
          docket: '6-20',
      ...
      cases: [
        {
          ...
          description:
            'State of Columbia (Nevada and DC combined) is unconstitutional and other bill severability issues.',
          ruling:
            'State of Columbia (Nevada and DC combined) is unconstitutional and other bill severability issues.',
          type: 'CIVIL',
          docket: '7-1 & 7-2',
        ...
        },
        {
          ...
          description:
            'Political question doctrine is "judicial policy" and due process does not apply to impeachment[s].',
          ruling:
            'Political question doctrine is "judicial policy" and due process does not apply to impeachment[s].',
          type: 'CIVIL',
          docket: '7-5',
        ...
        },
        {
          ...
          ruling: 'Mootness doctrine applied.',
          type: 'CIVIL',
          docket: '7-6',
        ...
        },
        {
          ...
          ruling: 'Expulsion of judges and the Fourteenth Amendment.',
          type: 'CIVIL',
          docket: '7-13',
        ...
        },
        {
          ...
          description:
            'Separation of powers issues and the trias politica doctrine and EB control of a Federal Bar exam.',
          ruling:
            'Separation of powers issues and the trias politica doctrine and EB control of a Federal Bar exam.',
          type: 'CIVIL',
          docket: '7-18',
        ...
        },
        {
          ...
          ruling: 'Congressional subpoenas and mootness.',
          type: 'CIVIL',
          docket: '7-26',
      ...
      cases: [
        {
          ...
          description:
            'Definition of "high crimes and misdemeanors" and impeachment issues (removal overturned).',
          ruling:
            'Definition of "high crimes and misdemeanors" and impeachment issues (removal overturned).',
          type: 'CIVIL',
          docket: '9-13',
        ...
        },
        {
          ...
          description:
            'Court ordered apologies are constitutional, may only be a secondary relief.',
          ruling: 'Court ordered apologies are constitutional, may only be a secondary relief.',
          type: 'CIVIL',
          docket: '9-15',
        ...
        },
        {
          ...
          description:
            'Utilisation of the suspension rule 62 in FRCRMP must be proper and constitutional issues.',
          ruling:
            'Utilisation of the suspension rule 62 in FRCRMP must be proper and constitutional issues.',
          type: 'CRIMINAL',
          docket: '9-21',
        ...
        },
        {
          ...
          description:
            'Congress lacks the authority to issue arrest warrants and AOS outside an Article III Court.',
          ruling:
            'Congress lacks the authority to issue arrest warrants and AOS outside an Article III Court.',
          type: 'CIVIL',
          docket: '9-14',
        ...
        },
        {
          ...
          ruling: 'Requirements to issue a stay order.',
          type: 'CRIMINAL',
          docket: '9-35',
        ...
        },
        {
          ...
          description:
            "Due process must be applied to EBB's, President cannot terminate those he doesn't appoint.",
          ruling:
            "Due process must be applied to EBB's, President cannot terminate those he doesn't appoint.",
          type: 'CIVIL',
          docket: '9-17',
      ...
      cases: [
        {
          ...
          description:
            'Dismissals with prejudice in accordance to EJA (legislation supporting this repealed)',
          ruling:
            'Dismissals with prejudice in accordance to EJA (legislation supporting this repealed)',
          type: 'CRIMINAL',
          docket: '10-04',
        ...
        },
        {
          ...
          description:
            'Recusals under Sec. 144 and showing bias is personal rather than judicial in nature',
          ruling:
            'Recusals under Sec. 144 and showing bias is personal rather than judicial in nature',
          type: 'CIVIL',
          docket: '10-08',
